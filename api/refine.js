...
import { transformTextPrompt, generateQuestionsPrompt, answerQuestionsPrompt, validateAnswersPrompt, enrichTextPrompt } from "./_prompts";
...
//     // const { text, transformationCommand, refine } = await request.body;
//     // if (!text || !transformationCommand || refine === undefined) {
//     //     return response.status(400).json({
//     //         error: "Invalid request body.",
//     //     });
//     // };
//     // const pipeline = invokePipeline(text, transformationCommand, refine);
//     // const encoder = new TextEncoder();
